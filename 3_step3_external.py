...
def _scanpy(mtx,obs,var,cluster_resolution):
	...
	sc.tl.leiden(adata,resolution=cluster_resolution,random_state=seed)
	df = pd.DataFrame()        
...
def _baseline(mtx,obs,var,cluster_resolution):
	...
	model = NMF(n_components=n_topics, init='random', random_state=seed)
...
# sample ='pbmc_s_3000_t_10_r_0.1_s_1'
# data_size = 3000
# n_topics=10
# cluster_resolution = 0.1
# seed = 1
# wdir = '/home/BCCRC.CA/ssubedi/projects/experiments/asapp/examples/sim/'
...
_baseline(mtx,obs,var,cluster_resolution)

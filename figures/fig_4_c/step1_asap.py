...
wdir = '/home/BCCRC.CA/ssubedi/projects/experiments/asapp/figures/fig_4_c/'
...
# 	dftemp = dfct.topic.value_counts()  
# 	selected_topic = dftemp[dftemp>1000].index.values
# 	### len of selected topic is 38 , will keep 480566 cells
 
# 	dfct = dfct[dfct['topic'].isin(selected_topic)]
...
# 	dfct_grp = dfct_grp.sort_values(['celltype'],ascending=False)
...
#  	dfct = dfct[dfct['celltype'].isin(selected_celltype)]
...
# # 	rgb_values = [list(map(int, line.strip().split(','))) for line in file]

# # # Convert RGB values to hex codes
# # hex_codes = [rgb_to_hex(rgb) for rgb in rgb_values]

# # # Print the resulting hex codes
# # arr = []

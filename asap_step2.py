...
pmf2t = asappy.pmf2topic(beta=asap_object.adata.varm['beta'] ,theta=asap_object.adata.uns['pseudobulk']['pb_theta'])
...
asappy.plot_gene_loading(asap_adata,top_n=10,max_thresh=10)
...
pmf2t = asappy.pmf2topic(beta=asap_adata.varm['beta'] ,theta=asap_adata.obsm['theta'])
asap_adata.obsm['theta_norm'] = pmf2t['prop']
asap_adata.varm['beta'] = pmf2t['beta']
asappy.plot_structure(asap_adata,'theta_norm')

asappy.plot_gene_loading(asap_adata,top_n=3,max_thresh=1000)
asappy.plot_gene_loading(asap_adata,top_n=3,max_thresh=100)
history
...
asappy.asap_nmf(asap_object,num_factors=50)
...
plot_gene_loading(asap_adata,top_n=5,max_thresh=200)


asappy.leiden_cluster(asap_adata,k=25,mode='corr',resolution=0.1)

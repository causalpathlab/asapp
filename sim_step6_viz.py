...
p = (
    ...
    geom_line(data=df, mapping=aes(x='size', y='score_mean', color='model'), linetype='dashed',size=2) + 
    labs(x='size', y='NMI')
)
p = p + theme(
...
p.save(filename = './results/nmf_eval.png', height=6, width=8, units ='in', dpi=300)

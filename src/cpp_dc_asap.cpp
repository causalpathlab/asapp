...
ASAPdcNMFResult ASAPdcNMF::online_nmf(const Eigen::MatrixXf in_beta_a, const Eigen::MatrixXf in_beta_b)
{   
    ...
    const Mat row_topic_a = Mat(in_beta_a);
    const Mat row_topic_b = Mat(in_beta_b);
